 ...
 */
public class PathToNative extends FileFunctionDefinition {

  private static final StructuredQName qName = new StructuredQName("", EXT_NAMESPACEURI, "path-to-native");
