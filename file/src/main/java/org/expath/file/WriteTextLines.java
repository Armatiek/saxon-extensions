 ...
 */
public class WriteTextLines extends FileFunctionDefinition {

  private static final StructuredQName qName = new StructuredQName("", EXT_NAMESPACEURI, "write-text-lines");
